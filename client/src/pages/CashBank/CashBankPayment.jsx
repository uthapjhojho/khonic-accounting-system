    ...
    const fetchInitialData = async () => {
        ...
        try {
            const [voucherRes, accRes] = await Promise.all([
                fetch('http://localhost:5000/api/journals/voucher/KK'),
    ...
    const handleSave = async () => {
        ...
        try {
            const payload = {
                ...
                payee_name: isCekKosong ? '' : namaPenerima,
                check_no: isCekKosong ? '' : noCek,
            ...
            const response = await fetch('http://localhost:5000/api/journals/payment', {
                method: 'POST',
                            ...
                            <div key={line.id} className="grid grid-cols-12 gap-4 items-center py-4 px-2 hover:bg-gray-50/30 transition-colors group">
                                ...
                                <div className="col-span-2 flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="text-gray-300 hover:text-green-400 transition-colors p-1"
                                    >
                                        <Trash2 size={16} />
                                    </button>
                                </div>
