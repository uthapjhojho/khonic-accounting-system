    ...
    try {
        ...
        await client.query(`
            ...
            BEGIN
                ...
                (cust_id_3, 'INV-2025-08-011', '2025-12-01', '2025-12-08', 5000000, 2000000, 'Partially Paid'),
                (cust_id_1, 'INV-2025-08-009', '2025-10-28', '2026-02-21', 500000, 0, 'Unpaid'),
                (cust_id_1, 'INV-2025-08-012', '2025-11-15', '2025-11-22', 15000000, 0, 'Unpaid'),
                ...
                (cust_id_4, 'INV-2025-08-013', '2025-12-05', '2025-12-12', 45000000, 15000000, 'Partially Paid'),
                (cust_id_7, 'INV-2025-08-003', '2025-10-28', '2026-02-21', 500000, 0, 'Unpaid'),
                (cust_id_5, 'INV-2025-11-001', '2025-11-01', '2025-11-08', 8200000, 0, 'Unpaid'),
                (cust_id_6, 'INV-2025-11-002', '2025-11-05', '2025-11-12', 12000000, 0, 'Unpaid'),
                (cust_id_8, 'INV-2025-11-003', '2025-11-10', '2025-11-17', 9500000, 0, 'Unpaid'),
                -- Gemilang Sejahtera Invoices for Tax Matching
                (cust_id_9, 'INV-2025-09-003', '2025-09-03', '2025-09-10', 3561811, 0, 'Unpaid'),
                (cust_id_9, 'INV-2025-09-004', '2025-09-03', '2025-09-10', 7049889, 7049889, 'Paid'),
                (cust_id_9, 'INV-2025-09-005', '2025-09-03', '2025-09-10', 2423730, 0, 'Unpaid'),
                (cust_id_9, 'INV-2025-12-001', '2025-12-01', '2025-12-08', 1000000000, 0, 'Unpaid')
